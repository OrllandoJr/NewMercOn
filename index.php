		...
		<div class="container">
			...
			<div class="side-bar col-md-3">
				<div class="search-hotel">
					<h3 class="agileits-sear-head">Deseja algo?</h3>
					<form action="#" method="post">
				...
				<!-- price range -->
				<div class="range">
					<h3 class="agileits-sear-head">Preços</h3>
				...
				<!-- food preference -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Preferença</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Pizza</span>
						</li>
						<li>
							<input type="checkbox" class="checked">
							<span class="span">Cervejas</span>
						</li>
					</ul>
				</div>
				<!-- //food preference -->
				<!-- discounts -->
				<div class="left-side">
					<h3 class="agileits-sear-head">Disconto</h3>
					<ul>
						<li>
							<input type="checkbox" class="checked">
